 ...
 * <ul>
 * <li> `browser:uncompressed` - build uncomprssed browser bundle (`unitedcore-*.js`)
 * <li> `browser:compressed` - build compressed browser bundle (`unitedcore-*.min.js`)
...
function startGulp(name, opts) {
  ...
  var fullname = name ? 'unitedcore-' + name : 'unitedcore';
  var files = ['lib/**/*.js'];
  var tests = ['test/**/*.js'];
  var alljs = files.concat(tests);

  var buildPath = './node_modules/unitedcore-build/';
  ...
  if (browser) {
    ...
    if (name !== 'lib') {
      browserifyCommand = buildBinPath + 'browserify --require ./index.js:' + fullname + ' --external unitedcore-lib -o ' + fullname + '.js';
    } else {
      browserifyCommand = buildBinPath + 'browserify --require ./index.js:unitedcore-lib -o unitedcore-lib.js';
    }
